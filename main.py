...
#source = '/mnt/alienware-hdd/Job/Help/Human-Falling-Detect-Tracks/fall_1.avi'
#source = 2
...
if __name__ == '__main__':
    ...
    par.add_argument('-o','--outfile', type=str, default='',
    ...
    if args.outfile != '':
        ...
        writer = cv2.VideoWriter(args.outfile, codec, 30, (inp_dets * 2, inp_dets * 2))
